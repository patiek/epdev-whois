...
class EP_Dev_Whois_Config
{
	...
	function EP_Dev_Whois_Config()
	{
		...
		$this->BUYMODE['CONFIG']['domain_suggestions'] = "";
	...
	<ip>[[IP]]</ip>
	<domain>[[DOMAIN-PUNY]]</domain>
	<ext>[[EXT]]</ext>
</query>
";
		$this->SCRIPT['LOGS']['short_format'] = "[[MONTH]]-[[DAY]]-[[YEAR]]	[[DOMAIN-PUNY]].[[EXT]]		[[IP]]
";

		$this->SCRIPT['remove_notices'] = true;
		$this->SCRIPT['translate_idn'] = true;
		$this->SCRIPT['idn_extensions'] = "";
		$this->SCRIPT['image_verification'] = "";
		$this->SCRIPT['custom_header'] = "";
		$this->SCRIPT['custom_footer'] = "";
		$this->SCRIPT['email_images'] = "";
		$this->SCRIPT['limit_bypass'] = true;
		$this->SCRIPT['copyright'] = true;
		$this->SCRIPT['absolute_path'] = "";
		$this->SCRIPT['version'] = "2.31";

		$this->SCRIPT['SITE']['title'] = "Whois Search";
		$this->SCRIPT['SITE']['url'] = "";


		$this->SCRIPT['CACHE']['time'] = 5;
		$this->SCRIPT['CACHE']['folder'] = "cache/";
		...
		$this->FILES['folder']['images'] = "images/";
		$this->FILES['folder']['classes'] = "classes/";
		$this->FILES['folder']['admin'] = "admin/";

		$this->FILES['file']['cache'] = $this->FILES['folder']['classes'] . "cache.php";
		$this->FILES['file']['idn'] = $this->FILES['folder']['classes'] . "IDN/idna_convert.class.php";
		$this->FILES['file']['securityimage'] = $this->FILES['folder']['classes'] . "securityImage.php";
		$this->FILES['file']['image'] = $this->FILES['folder']['classes'] . "image.php";
		$this->FILES['file']['emailimage'] = $this->FILES['folder']['classes'] . "emailImage.php";
		...
		$this->NAMESERVERS['whois.crsnic.net']['enabled'] = false;
		...
		$this->NAMESERVERS['whois.crsnic.net']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.crsnic.net']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.crsnic.net']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.publicinterestregistry.net']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.publicinterestregistry.net']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.publicinterestregistry.net']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.nic.uk']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.uk']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.uk']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.nic.us']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.us']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.us']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.neulevel.biz']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.neulevel.biz']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.neulevel.biz']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.afilias.info']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.afilias.info']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.afilias.info']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.website.ws']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.website.ws']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.website.ws']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.nic.name']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.name']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.name']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.nic.cc']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.cc']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.cc']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.cira.ca']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.cira.ca']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.cira.ca']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.cnnic.net.cn']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.cnnic.net.cn']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.cnnic.net.cn']['advanced_custom_query_address'] = "[[SERVER]]:43";
		$this->NAMESERVERS['whois.cnnic.net.cn']['timeout'] = 30;
		$this->NAMESERVERS['whois.cnnic.net.cn']['extensions'] = "cn,hk.cn";
		$this->NAMESERVERS['whois.cnnic.net.cn']['extensions_disabled'] = "nx.cn,yn.cn,gd.cn,js.cn,he.cn,org.cn,net.cn,cq.cn,hl.cn,hn.cn,gz.cn,qh.cn,mo.cn,gs.cn,sc.cn,hb.cn,jl.cn,tj.cn,gov.cn,com.cn,sh.cn,ln.cn,ah.cn,hi.cn,sn.cn,xj.cn,xz.cn,tw.cn,gx.cn,zj.cn,nm.cn,bj.cn,ac.cn";
		...
		$this->NAMESERVERS['whois.cnnic.cn']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.cnnic.cn']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.cnnic.cn']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.nic.tm']['keyword'] = "- Available";
		$this->NAMESERVERS['whois.nic.tm']['format'] = "[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.nic.tm']['limit_format'] = "[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.nic.tm']['limit_keyword'] = "- Available";
		$this->NAMESERVERS['whois.nic.tm']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.tm']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.tm']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.domain-registry.nl']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.domain-registry.nl']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.domain-registry.nl']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.denic.de']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.denic.de']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.denic.de']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois-check.ausregistry.net.au']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois-check.ausregistry.net.au']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois-check.ausregistry.net.au']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.centralnic.com']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.centralnic.com']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.centralnic.com']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.isoc.org.il']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.isoc.org.il']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.isoc.org.il']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.ripe.net']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.ripe.net']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.ripe.net']['advanced_custom_query_address'] = "[[SERVER]]:43";
		$this->NAMESERVERS['whois.ripe.net']['timeout'] = 30;
		$this->NAMESERVERS['whois.ripe.net']['extensions'] = "ac,ac.ac,co.ac,gv.ac,or.ac,cz,fo,org.il,k12.il,gov.il,is,it,lt,lu,asso.mc,tm.mc,pt,com.ro,org.ro,www.ro,info.ro";
		$this->NAMESERVERS['whois.ripe.net']['extensions_disabled'] = "ac.be,ac.il,arts.ro,co.il,firm.ro,dk,muni.il,net.il,nom.ro,nt.ro,rec.ro,sk,store.ro,tm.ro";
		...
		$this->NAMESERVERS['whois.netnames.net']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.netnames.net']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.netnames.net']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.nic.am']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.am']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.am']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.nic.as']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.as']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.as']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.nic.at']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.at']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.at']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.aunic.net']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.aunic.net']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.aunic.net']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.audns.net.au']['enabled'] = false;
		$this->NAMESERVERS['whois.audns.net.au']['keyword'] = "No Data Found";
		$this->NAMESERVERS['whois.audns.net.au']['format'] = "[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.audns.net.au']['limit_format'] = "[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.audns.net.au']['limit_keyword'] = "No Data Found";
		$this->NAMESERVERS['whois.audns.net.au']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.audns.net.au']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.audns.net.au']['advanced_custom_query_address'] = "[[SERVER]]:43";
		$this->NAMESERVERS['whois.audns.net.au']['timeout'] = 30;
		$this->NAMESERVERS['whois.audns.net.au']['extensions'] = "net.au";
		$this->NAMESERVERS['whois.audns.net.au']['extensions_disabled'] = "";
		...
		$this->NAMESERVERS['whois.dns.be']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.dns.be']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.dns.be']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.nic.ch']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.ch']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.ch']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.nic.cx']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.cx']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.cx']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.nic.fr']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.fr']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.fr']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.adamsnames.tc']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.adamsnames.tc']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.adamsnames.tc']['advanced_custom_query_address'] = "[[SERVER]]:43";
		$this->NAMESERVERS['whois.adamsnames.tc']['timeout'] = 30;
		$this->NAMESERVERS['whois.adamsnames.tc']['extensions'] = "tc,vg";
		...
		$this->NAMESERVERS['whois.nic.tf']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.tf']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.tf']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.jprs.jp']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.jprs.jp']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.jprs.jp']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.nic.or.kr']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.or.kr']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.or.kr']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.nic.li']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.li']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.li']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.mx']['enabled'] = false;
		$this->NAMESERVERS['whois.mx']['keyword'] = "No_Se_Encontro_El_Objeto/Object_Not_Found";
		$this->NAMESERVERS['whois.mx']['format'] = "[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.mx']['limit_format'] = "[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.mx']['limit_keyword'] = "=No_Se_Encontro_El_Objeto/Object_Not_Found";
		$this->NAMESERVERS['whois.mx']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.mx']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.mx']['advanced_custom_query_address'] = "[[SERVER]]:43";
		$this->NAMESERVERS['whois.mx']['timeout'] = 30;
		$this->NAMESERVERS['whois.mx']['extensions'] = "mx,com.mx,net.mx,org.mx,edu.mx";
		$this->NAMESERVERS['whois.mx']['extensions_disabled'] = "";
		...
		$this->NAMESERVERS['whois.norid.no']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.norid.no']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.norid.no']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.nic.nu']['keyword'] = "NO MATCH for";
		$this->NAMESERVERS['whois.nic.nu']['format'] = "[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.nic.nu']['limit_format'] = "[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.nic.nu']['limit_keyword'] = "NO MATCH for";
		$this->NAMESERVERS['whois.nic.nu']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.nu']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.nu']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.dns.pl']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.dns.pl']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.dns.pl']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.ripn.net']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.ripn.net']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.ripn.net']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.nic-se.se']['keyword'] = "not found.";
		$this->NAMESERVERS['whois.nic-se.se']['format'] = "[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.nic-se.se']['limit_format'] = "[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.nic-se.se']['limit_keyword'] = "not found.";
		$this->NAMESERVERS['whois.nic-se.se']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic-se.se']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic-se.se']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.arnes.si']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.arnes.si']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.arnes.si']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.nic.net.sg']['keyword'] = "Domain Not Found";
		$this->NAMESERVERS['whois.nic.net.sg']['format'] = "[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.nic.net.sg']['limit_format'] = "[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.nic.net.sg']['limit_keyword'] = "Domain Not Found";
		$this->NAMESERVERS['whois.nic.net.sg']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.net.sg']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.net.sg']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.nic.st']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.st']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.st']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.thnic.net']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.thnic.net']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.thnic.net']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['monarch.tonic.to']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['monarch.tonic.to']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['monarch.tonic.to']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.metu.edu.tr']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.metu.edu.tr']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.metu.edu.tr']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.twnic.net']['keyword'] = "No Found";
		$this->NAMESERVERS['whois.twnic.net']['format'] = "[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.twnic.net']['limit_format'] = "[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.twnic.net']['limit_keyword'] = "No Found";
		$this->NAMESERVERS['whois.twnic.net']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.twnic.net']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.twnic.net']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.ja.net']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.ja.net']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.ja.net']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.nic.tv']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.tv']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.tv']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->NAMESERVERS['whois.verisign-grs.com']['enabled'] = true;
		$this->NAMESERVERS['whois.verisign-grs.com']['keyword'] = "No match";
		$this->NAMESERVERS['whois.verisign-grs.com']['format'] = "=[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.verisign-grs.com']['limit_format'] = "=[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.verisign-grs.com']['limit_keyword'] = "No match";
		$this->NAMESERVERS['whois.verisign-grs.com']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.verisign-grs.com']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.verisign-grs.com']['advanced_custom_query_address'] = "[[SERVER]]:43";
		$this->NAMESERVERS['whois.verisign-grs.com']['timeout'] = 30;
		$this->NAMESERVERS['whois.verisign-grs.com']['extensions'] = "com,net";
		$this->NAMESERVERS['whois.verisign-grs.com']['extensions_disabled'] = "";


		$this->NAMESERVERS['whois.educause.edu']['enabled'] = true;
		$this->NAMESERVERS['whois.educause.edu']['keyword'] = "No match";
		$this->NAMESERVERS['whois.educause.edu']['format'] = "=[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.educause.edu']['limit_format'] = "=[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.educause.edu']['limit_keyword'] = "No match";
		$this->NAMESERVERS['whois.educause.edu']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.educause.edu']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.educause.edu']['advanced_custom_query_address'] = "[[SERVER]]:43";
		$this->NAMESERVERS['whois.educause.edu']['timeout'] = 30;
		$this->NAMESERVERS['whois.educause.edu']['extensions'] = "edu";
		$this->NAMESERVERS['whois.educause.edu']['extensions_disabled'] = "";


		$this->NAMESERVERS['whois.eu']['enabled'] = true;
		$this->NAMESERVERS['whois.eu']['keyword'] = "Status:	AVAILABLE";
		$this->NAMESERVERS['whois.eu']['format'] = "[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.eu']['limit_format'] = "[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.eu']['limit_keyword'] = "Status:	AVAILABLE";
		$this->NAMESERVERS['whois.eu']['timeout'] = 30;
		$this->NAMESERVERS['whois.eu']['extensions'] = "eu";
		$this->NAMESERVERS['whois.eu']['extensions_disabled'] = "";
		$this->NAMESERVERS['whois.eu']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.eu']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.eu']['advanced_custom_query_address'] = "[[SERVER]]:43";


		$this->NAMESERVERS['whois.nic.ms']['enabled'] = true;
		$this->NAMESERVERS['whois.nic.ms']['keyword'] = "Status: Not Registered";
		$this->NAMESERVERS['whois.nic.ms']['format'] = "[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.nic.ms']['limit_format'] = "[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.nic.ms']['limit_keyword'] = "Status: Not Registered";
		$this->NAMESERVERS['whois.nic.ms']['timeout'] = 30;
		$this->NAMESERVERS['whois.nic.ms']['extensions'] = "ms";
		$this->NAMESERVERS['whois.nic.ms']['extensions_disabled'] = "";
		$this->NAMESERVERS['whois.nic.ms']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.ms']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.ms']['advanced_custom_query_address'] = "[[SERVER]]:43";


		$this->NAMESERVERS['whois.nic.gs']['enabled'] = true;
		$this->NAMESERVERS['whois.nic.gs']['keyword'] = "Status: Not Registered";
		$this->NAMESERVERS['whois.nic.gs']['format'] = "[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.nic.gs']['limit_format'] = "[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.nic.gs']['limit_keyword'] = "Status: Not Registered";
		$this->NAMESERVERS['whois.nic.gs']['timeout'] = 30;
		$this->NAMESERVERS['whois.nic.gs']['extensions'] = "gs";
		$this->NAMESERVERS['whois.nic.gs']['extensions_disabled'] = "";
		$this->NAMESERVERS['whois.nic.gs']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.gs']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.nic.gs']['advanced_custom_query_address'] = "[[SERVER]]:43";


		$this->NAMESERVERS['whois.dotmobiregistry.net']['enabled'] = true;
		$this->NAMESERVERS['whois.dotmobiregistry.net']['keyword'] = "NOT FOUND";
		$this->NAMESERVERS['whois.dotmobiregistry.net']['format'] = "[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.dotmobiregistry.net']['limit_format'] = "[[DOMAIN]].[[EXT]]";
		$this->NAMESERVERS['whois.dotmobiregistry.net']['limit_keyword'] = "NOT FOUND";
		$this->NAMESERVERS['whois.dotmobiregistry.net']['timeout'] = 30;
		$this->NAMESERVERS['whois.dotmobiregistry.net']['extensions'] = "mobi";
		$this->NAMESERVERS['whois.dotmobiregistry.net']['extensions_disabled'] = "";
		$this->NAMESERVERS['whois.dotmobiregistry.net']['advanced_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.dotmobiregistry.net']['advanced_limit_custom_query'] = "[[QUERY]]\\r\\n";
		$this->NAMESERVERS['whois.dotmobiregistry.net']['advanced_custom_query_address'] = "[[SERVER]]:43";
		...
		$this->BUYMODE['PRICES']['eu'] = "9.95";
		$this->BUYMODE['PRICES']['mobi'] = "0.00";

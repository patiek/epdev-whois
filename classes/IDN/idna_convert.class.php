...
/* ------------------------------------------------------------------ */
//	IDN conversion class
//  This is a third-party class that is used for conversion of domains to 
//	to ACE format. Some files are missing that were not being used.
//
//	You can find additional details pertaining to this code as well as
//	the authors below. The LICENSE under which the library was released 
//	as well as the original ReadMe.txt should have also been included 
//	and can be found in the folder in which this file resides.
//
//	Date: 3/21/2006
/* ------------------------------------------------------------------ */
...
class EP_Dev_Whois_IDNA
{
    ...
    // The constructor
    function EP_Dev_Whois_IDNA($options = false)
    {
...
* @author  Matthias Sommerfeld <mso@phlylabs.de>
*/
class EP_Dev_Whois_IDNA_Net_IDNA_php4 extends EP_Dev_Whois_IDNA
{
    /**
    * Sets a new option value. Available options and values:
    * [encoding - Use either UTF-8, UCS4 as array or UCS4 as string as input ('utf8' for UTF-8,
